...
var Globals = function (inputTree) {
  ...
  this.globalNameMapping = {
    'ember-table-old/components/ember-table': 'Ember.Table.EmberTableComponent',
    'ember-table-old/controllers/row-array': 'Ember.Table.RowArrayController',
    'ember-table-old/controllers/row': 'Ember.Table.Row',
    'ember-table-old/mixins/mouse-wheel-handler': 'Ember.MouseWheelHandlerMixin',
    'ember-table-old/mixins/register-table-component': 'Ember.Table.RegisterTableComponentMixin',
    'ember-table-old/mixins/resize-handler': 'Ember.AddeparMixins.ResizeHandlerMixin',
    'ember-table-old/mixins/scroll-handler': 'Ember.ScrollHandlerMixin',
    'ember-table-old/mixins/show-horizontal-scroll': 'Ember.Table.ShowHorizontalScrollMixin',
    'ember-table-old/mixins/style-bindings': 'Ember.AddeparMixins.StyleBindingsMixin',
    'ember-table-old/mixins/touch-move-handler': 'Ember.TouchMoveHandlerMixin',
    'ember-table-old/models/column-definition': 'Ember.Table.ColumnDefinition',
    'ember-table-old/views/body-table-container': 'Ember.Table.BodyTableContainer',
    'ember-table-old/views/column-sortable-indicator': 'Ember.Table.ColumnSortableIndicator',
    'ember-table-old/views/footer-table-container': 'Ember.Table.FooterTableContainer',
    'ember-table-old/views/header-block': 'Ember.Table.HeaderBlock',
    'ember-table-old/views/header-cell': 'Ember.Table.HeaderCell',
    'ember-table-old/views/header-row': 'Ember.Table.HeaderRow',
    'ember-table-old/views/header-table-container': 'Ember.Table.HeaderTableContainer',
    'ember-table-old/views/lazy-container': 'Ember.LazyContainerView',
    'ember-table-old/views/lazy-item': 'Ember.LazyItemView',
    'ember-table-old/views/lazy-table-block': 'Ember.Table.LazyTableBlock',
    'ember-table-old/views/multi-item-collection': 'Ember.MultiItemViewCollectionView',
    'ember-table-old/views/scroll-container': 'Ember.Table.ScrollContainer',
    'ember-table-old/views/scroll-panel': 'Ember.Table.ScrollPanel',
    'ember-table-old/views/table-block': 'Ember.Table.TableBlock',
    'ember-table-old/views/table-cell': 'Ember.Table.TableCell',
    'ember-table-old/views/table-container': 'Ember.Table.TableContainer',
    'ember-table-old/views/table-row': 'Ember.Table.TableRow'
  };
};
