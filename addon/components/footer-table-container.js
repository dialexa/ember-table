...
import MouseWheelHandlerMixin from 'ember-table-old/mixins/mouse-wheel-handler';
import TouchMoveHandlerMixin from 'ember-table-old/mixins/touch-move-handler';
